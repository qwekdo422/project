...
<body style="margin:0 auto;">
   <div id="header">
	...
	<form method="post" id="nfrm"action="../Rboard/RbaordProc.do">
	<input type="hidden" name="rno" value="${rVO.rno}"><!-- 그냥 VO로 넘겨지는 거란다 -->
	<table class="table table-hover table-striped table-bordered mt-4">
		<tr>
			<td>
				<input type="text" name="rtitle" id="rtitle"  style="width:100%" placeholder="제목을 입력해주세요" value="${rVO.rtitle}">
			</td>
		</tr>
		 <tr>
		 	<td colspan="2">
		 		<textarea  id="rbody" name="rcontents" row="100" cols="110"  >${rVO.rcontents}</textarea>
		  </td>
		 </tr>
		  <tr>
