...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left=500,top=250,width=512em,height=288em,scrollbars=yes,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		...
		var sPopupUrl = "http://localhost:8080/teacher/Common/ImageUploadForm.sun"; 
		return sPopupUrl;
	},
