...
public class MailForm {
	public static String makeMail(MailVO mvo) {
        ...
        if(mvo.getYesno()==true) {
        	buff.append(mvo.getName() + "님은 " + mvo.getDate() + ", 저희 애정촌에" + mvo.getNick() + "로 참가하게 되셨습니다.<br />");
            ...
            buff.append("			이번 신청자가 많아 부득이하게 " + mvo.getName() + " 님은 참가하지 못하게 되셨습니다.<br />");
